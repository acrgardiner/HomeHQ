...
public static class Formatter
{
    ...
    {
        return !date.HasValue ? "" : date.Value.Date.ToString("d", CultureInfo.CurrentCulture);
    }

    public static string FormatDate(DateTime? date, string format)
    {
        return !date.HasValue ? "" : date.Value.Date.ToString(format, CultureInfo.CurrentCulture);
    }
